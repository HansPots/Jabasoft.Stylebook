...
eigen database (`JabaSoftTelemetry`), zodat meerdere apps er allemaal in
kunnen schrijven zonder elkaars data te raken, en er één grafiek over alle
apps heen gemaakt kan worden.
...
2. Zelfde `ConnectionStrings:JabaSoftTelemetry` in `appsettings.json`.
